package NGS::Tools::GATK::Roles::CombineVariants;
use Moose::Role;
...
A Perl Moose Role wrapper for the GATK CombineVariants program.

=head1 ATTRIBUTES AND DELEGATES

=head1 SUBROUTINES/METHODS

=head2 $obj->combine_variants()

A method for merging multiple VCF files into a single VCF file.

=head3 Arguments:

=over 2

=item * vcf: [ArrayRef] an array reference containing the VCF files to combine.

=item * sample: [String] a string containing the sample name, this will be used in the combined VCF output filename.
...
You can find documentation for this module with the perldoc command.
    ...
    perldoc NGS::Tools::GATK::Roles::CombineVariants
...
1; # End of NGS::Tools::GATK::Roles::CombineVariants
